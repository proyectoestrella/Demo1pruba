...
const COLUMNA: Record<string, string> = {
  ...
  depositReceivedEur: "deposit_received_eur",
  depositAppliedAt: "deposit_applied_at",
  depositAppliedEur: "deposit_applied_eur",
  depositRefundedAt: "deposit_refunded_at",
  depositRefundedEur: "deposit_refunded_eur",
  depositRetainedAt: "deposit_retained_at",
