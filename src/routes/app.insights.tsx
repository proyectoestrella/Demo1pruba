import { aiInsightsMemo, barrasDelPeriodoMemo, nuevasYRecurrentesMemo, ocupacionPorProfesionalMemo, serviciosDelRangoMemo } from "@/lib/selectores-rutas";
...
function Insights() {
  ...
  const cards = useMemo(() => aiInsightsMemo(appointments, employees), [appointments, employees]);
...
barras: barrasDelPeriodoMemo(appointments, periodo, r, employees, ahora),
ocupacion: ocupacionPorProfesionalMemo(appointments, r, employees),
servicios: serviciosDelRangoMemo(appointments, r, services).slice(0, 6),
clientas: nuevasYRecurrentesMemo(appointments, r),
    };
