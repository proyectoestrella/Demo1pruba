...
export interface ShimmerButtonProps extends ComponentPropsWithoutRef<"button"> {
  /**
   * Añadido respecto al original: renderiza el hijo en vez de un <button>.
   * Necesario para usarlo como enlace — un <button> dentro de un <a> es HTML
   * inválido, y este botón es el CTA principal, que debe seguir siendo enlace.
   */
  asChild?: boolean;
  shimmerColor?: string;
  shimmerSize?: string;
