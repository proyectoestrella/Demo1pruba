...
- **`precalentar()`** prepara el catálogo, los índices y los cálculos de marketing. Con 3.300 citas tarda unos 300 ms. Después, cada pregunta tarda menos de 20 ms. Si no se llama, lo paga la primera pregunta.
...
| `pistas.ts` | Reglas legibles que refuerzan una intención cuando aparece su expresión característica |
